...
void ofxNCoreVision::updateMainPanels()
{
	...
	****************************/
	...
	// Reward
	controls->update(appPtr->rewPanel_distThresh, kofxGui_Set_Bool, &distThresh, sizeof(float));
	controls->update(appPtr->rewPanel_followingPropThresh, kofxGui_Set_Bool, &followingPropThresh, sizeof(float));
	controls->update(appPtr->rewPanel_continuousFollowingThresh, kofxGui_Set_Bool, &continuousFollowingThresh, sizeof(float));
	controls->update(appPtr->rewPanel_maxVelThresh, kofxGui_Set_Bool, &maxVelThresh, sizeof(float));
	//Threshold
	...
	controls->update(appPtr->optionPanel_daq, kofxGui_Set_Bool, &appPtr->bUseDaq, sizeof(bool));
...
void ofxNCoreVision::addMainPanels() 
{
	...
	oPanel->addButton(appPtr->optionPanel_daq, "DAQ DIO", OFXGUI_BUTTON_HEIGHT, OFXGUI_BUTTON_HEIGHT, kofxGui_Button_Off, kofxGui_Button_Switch);
	oPanel->mObjWidth = 200;
	oPanel->mObjHeight = 120;

	// Templates


	// Transforms
	ofxGuiPanel* propPanel = controls->addPanel(appPtr->propertiesPanel, "Transforms", MAIN_PANEL_SECOND_X, 293 - (bcamera ? 0 : 80), 12, OFXGUI_PANEL_SPACING);
	...
	// Saving/Logging
	ofxGuiPanel* logPanel = controls->addPanel(appPtr->logPanel, "Logging/Saving", MAIN_PANEL_SECOND_X, 467 -(bcamera ? 0 : 80), OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	logPanel->addButton(appPtr->logPanel_detectEdges, "Detect Paths (D)", OFXGUI_BUTTON_HEIGHT, OFXGUI_BUTTON_HEIGHT, kofxGui_Button_Off, kofxGui_Button_Trigger);
	...
	ofxGuiPanel* triggerPanel = controls->addPanel(appPtr->triggerPanel, "", MAIN_PANEL_SECOND_X, 597 -(bcamera ? 0 : 80), OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	rewPanel->mObjects[2]->mObjY = 85; //expPanel->mObjects[4]->mObjX = 135;
	rewPanel->mObjects[3]->mObjY = 115; //expPanel->mObjects[5]->mObjX = 135;
	rewPanel->mObjWidth = 165;
	rewPanel->mObjHeight = 145;
