...
void ofxCameraBase::updateCurrentFrame()
{
	...
	//FlyCapture2::Image tempIm(height, width, width, cameraFrame, height*width*depth*sizeof(unsigned char), FlyCapture2::PIXEL_FORMAT_RGB8);
	//FlyCapture2::Image tempIm(height, width, width, cameraFrame, height*width*depth*sizeof(unsigned char), FlyCapture2::PIXEL_FORMAT_MONO8);
	//tempIm.Save("FleaTemp_image2.bmp");
	if (depth>1)
	{
